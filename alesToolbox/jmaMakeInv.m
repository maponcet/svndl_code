function [varargout] = jmaMakeInv(fname_fwd,lambda2,srcSpace,srcCor)
%function [sol] = jmaMakeInv(fname_inv,lambda2,dSPM,srcSpace,srcCor)
%function [u s v] = jmaMakeInv(fname_inv,lambda2,dSPM,srcSpace,srcCor)
%
